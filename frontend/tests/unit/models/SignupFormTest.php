...
class SignupFormTest extends \Codeception\Test\Unit
{
    ...
    public function testCorrectSignup()
    {
        ...
        /** @var \common\models\BackendModels\User $user */
        $user = $this->tester->grabRecord('common\models\BackendModels\User', [
            'username' => 'some_username',
            'email' => 'some_email@example.com',
            'status' => \common\models\BackendModels\User::STATUS_INACTIVE
        ]);
